...
function compileAllContracts(diagnosticCollection) {
    ...
    return files.then(documents => {
        ...
        compiler_1.compile(contractsCollection.getDefaultContractsForCompilation(compilationOptimisation), diagnosticCollection, project.projectPackage.build_dir, project.projectPackage.absoluletPath, sourceDirPath, packagesPath);
    });
}
